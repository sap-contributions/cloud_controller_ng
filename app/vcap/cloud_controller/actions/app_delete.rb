...
require 'vcap/cloud_controller/jobs/v3/buildpack_cache_delete'
require 'vcap/cloud_controller/actions/package_delete'
require 'vcap/cloud_controller/actions/task_delete'
require 'vcap/cloud_controller/actions/build_delete'
require 'vcap/cloud_controller/actions/droplet_delete'
require 'vcap/cloud_controller/actions/deployment_delete'
require 'vcap/cloud_controller/actions/label_delete'
require 'vcap/cloud_controller/actions/annotation_delete'
require 'vcap/cloud_controller/actions/revision_delete'
require 'vcap/cloud_controller/actions/process_delete'
require 'vcap/cloud_controller/actions/sidecar_delete'
require 'vcap/cloud_controller/actions/route_mapping_delete'
require 'vcap/cloud_controller/actions/staging_cancel'
require 'vcap/cloud_controller/actions/mixins/bindings_delete'

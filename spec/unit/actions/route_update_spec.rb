  ...
  RSpec.describe RouteUpdate do
    ...
    describe '#update options' do
      context 'when the route has no existing options' do
        ...
        context 'when an option is specified' do
          ...
          it 'adds the route option' do
            ...
            route.reload
            expect(route[:options]).to eq('{"loadbalancing_algorithm":"round-robin"}')
          end
        end
      end
      ...
      context 'when the route has existing options' do
        before do
          route[:options] = '{"loadbalancing_algorithm": "round-robin"}'
        end
        ...
        context 'when no options are specified' do
          ...
          it 'modifies nothing' do
            ...
            subject.update(route:, message:)
            route.reload
            expect(route.options).to include({ 'loadbalancing_algorithm' => 'round-robin' })
          end
        end
        ...
        context 'when an option is specified' do
          let(:body) do
            {
              options: {
                loadbalancing_algorithm: 'least-connections'
              }
            }
          end
          ...
          it 'updates the option' do
            ...
            expect(route.options).to include({ 'loadbalancing_algorithm' => 'least-connections' })
          end
        end

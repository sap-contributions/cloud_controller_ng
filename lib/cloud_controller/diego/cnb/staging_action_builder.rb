  ...
  module Diego
    module CNB
      class StagingActionBuilder
        ...
        def stack
          'docker://paketobuildpacks/builder-jammy-base'
        end

        def task_environment_variables
          [
            ::Diego::Bbs::Models::EnvironmentVariable.new(name: 'CNB_PLATFORM_API', value: '0.11'),
            ::Diego::Bbs::Models::EnvironmentVariable.new(name: 'CNB_USER_ID', value: '1000'),
            ::Diego::Bbs::Models::EnvironmentVariable.new(name: 'CNB_GROUP_ID', value: '1000')
          ]
        end

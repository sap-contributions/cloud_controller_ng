...
require 'vcap/cloud_controller/actions/app_create'
require 'vcap/cloud_controller/actions/app_update'
require 'vcap/cloud_controller/actions/app_patch_environment_variables'
require 'vcap/cloud_controller/actions/app_delete'
require 'vcap/cloud_controller/actions/app_restart'
require 'vcap/cloud_controller/actions/app_apply_manifest'
require 'vcap/cloud_controller/actions/app_start'
require 'vcap/cloud_controller/actions/app_stop'
require 'vcap/cloud_controller/actions/app_assign_droplet'
require 'vcap/cloud_controller/decorators/include_space_decorator'
require 'vcap/cloud_controller/decorators/include_organization_decorator'
require 'vcap/cloud_controller/decorators/include_space_organization_decorator'
require 'vcap/cloud_controller/messages/apps_list_message'
require 'vcap/cloud_controller/messages/app_show_message'
require 'vcap/cloud_controller/messages/app_update_message'
require 'vcap/cloud_controller/messages/app_create_message'
require 'vcap/cloud_controller/messages/update_environment_variables_message'
require 'vcap/cloud_controller/messages/app_manifest_message'
require 'vcap/cloud_controller/messages/app_builds_list_message'
require 'vcap/cloud_controller/presenters/v3/app_presenter'
require 'vcap/cloud_controller/presenters/v3/app_env_presenter'
require 'vcap/cloud_controller/presenters/v3/app_environment_variables_presenter'
require 'vcap/cloud_controller/presenters/v3/paginated_list_presenter'
require 'vcap/cloud_controller/presenters/v3/app_droplet_relationship_presenter'
require 'vcap/cloud_controller/presenters/v3/build_presenter'
require 'vcap/cloud_controller/fetchers/app_list_fetcher'
require 'vcap/cloud_controller/fetchers/app_builds_list_fetcher'
require 'vcap/cloud_controller/fetchers/app_fetcher'
require 'vcap/cloud_controller/fetchers/assign_current_droplet_fetcher'
require 'vcap/cloud_controller/repositories/app_event_repository'

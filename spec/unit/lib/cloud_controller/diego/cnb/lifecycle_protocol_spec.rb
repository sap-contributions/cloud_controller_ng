          ...
          it_behaves_like 'a lifecycle protocol' do
            ...
            let(:staging_details) do
              Diego::StagingDetails.new.tap do |details|
                ...
                details.lifecycle    = instance_double(CNBLifecycle, staging_stack: 'potato-stack', buildpack_infos: buildpack_infos, credentials: '{"registry":{"username":"password"}}')
              end
            end
          ...
          describe '#staging_action_builder' do
            ...
            let(:staging_details) do
              StagingDetails.new.tap do |details|
                details.lifecycle    = instance_double(CNBLifecycle, staging_stack: 'potato-stack', buildpack_infos: 'some buildpack info', credentials: '{"registry":{"username":"password"}}')
                details.package      = package
                details.staging_guid = droplet.guid
              end
            end

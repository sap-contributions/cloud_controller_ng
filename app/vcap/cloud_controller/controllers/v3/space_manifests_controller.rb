require 'vcap/cloud_controller/presenters/v3/app_manifest_presenter'
...
require 'vcap/cloud_controller/actions/app_find_or_create_skeleton'
require 'vcap/cloud_controller/actions/app_create'
require 'vcap/cloud_controller/actions/space_diff_manifest'
